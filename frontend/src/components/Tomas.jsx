...
const Tomas = () => {
    ...
    const formattedFecha = formatFecha(fecha);
          ...
          // SEGUNDO FETCH → enviar id_toma y fecha
        ...
        <div style={{marginBottom: "10%"}}>
            ...
            <div className="container" style={{width: "20%", height: "auto" }}>
                <div className="image-container">
                    ...
                    <div className="speech-bubble" >{mensaje}</div>
                </div>
            </div>
          ...
          <ul style={{ listStyleType: "none" }}>
            {selectedMeds.map((med, index) => (
              ...
              >
                ...
                <button
                  onClick={() =>
                    eliminarToma(id, med.medicamento, selectedDate.toLocaleDateString(), med.hora)
                  }
                  style={{
                    ...
                    <div key={index} className="button-container">
                        ...
                        {btn.label === "Editar parámetros" && showEditOptions && (
                            ...
                            >
                                ...
                                <button onClick={() => handleOptionClick("/tomas")} style={{ display: "block", marginBottom: "5px", color: "#2fa831" }}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
